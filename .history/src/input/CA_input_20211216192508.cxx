...
/*
 ...
 CA_input.cxx  contains a function that there is a grid with some cells which may be alive or dead. Our task to generate the next generation of cells based on the following rules: 
