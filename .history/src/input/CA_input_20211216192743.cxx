...
/*
 ...
 cells based on the following rules: A live cell with less than two live neighbors dies, live cell with two or three live neighbors lives on to the next generation.
